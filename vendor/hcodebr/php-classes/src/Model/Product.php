...
class Product extends Model{
	...
	//metodo criado por causa do campo de imagem
	public static function checklist($list)
	{
		foreach ($list as &$row) { //& para manipular a propria variavel
	...
	//reescrevendo a função getValues por causa do campo Phot
	...
	{
		$extension = explode(".", $file['name']); // transforma em array
		$extension = end($extension); // pega a ultima posição do array
